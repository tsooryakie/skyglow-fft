...
def parse_model_settings(path_to_model_settings: str) -> Dict:
    """
    This function parses the model resources from the resources.toml file.
    To run the model under different conditions, change the values in resources.toml file.
    :param path_to_model_settings: Path to resources.toml file
...
def apply_decay_function(
    ...
    :param model_settings: Model resources dictionary generated by reading the resources.toml file
